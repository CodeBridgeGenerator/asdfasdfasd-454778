...
<Column field="sku" header="Sku" body={pTemplate1} filter={selectedFilterFields.includes("sku")} hidden={selectedHideFields?.includes("sku")}  sortable style={{ minWidth: "8rem" }} />
